...
//	glEnable(GL_FOG);
	...
	texture.Bind(detail_texture_id);
...
/*	if (width != height)
	...
	sprintf(file_name, "./maps/%s/detail.jpg", name);
	detail_texture_id = texture.LoadTexture(file_name);
