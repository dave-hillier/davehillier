...
// Match asci so these arent needed
/*#define KEY_a			 97 
#define KEY_b			 98
#define KEY_c			 99
#define KEY_d			 100
...
#define KEY_MOUSE1			351
#define KEY_MOUSE3			352
#define KEY_MOUSE2			353
#define KEY_MOUSEWHEELUP	354
#define KEY_MOUSEWHEELDOWN	355
#define NUM_KEYS			356
...
public:
	int		code;
	char	ident[KEY_ID_LEN];
};
extern KeyCode keynames[];