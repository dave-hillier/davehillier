...
public:
    ...
    */
    ...
    void set_orientation_axis_angle(const vector3& v, float a) {
    ...
    void set_orientation_x(float a) {
        float sin_a = n_sin(a * 0.5f);
        float cos_a = n_cos(a * 0.5f);
        x = sin_a;
        y = 0.0f;
    ...
    void set_orientation_y(float a) {
        float sin_a = n_sin(a * 0.5f);
        float cos_a = n_cos(a * 0.5f);
        x = 0.0f;
        y = sin_a;
    ...
    void set_orientation_z(float a) {
        float sin_a = n_sin(a * 0.5f);
        float cos_a = n_cos(a * 0.5f);
        x = 0.0f;
        y = 0.0f;
    ...
    void set_orientation_xyz(float ax, float ay, float az) {
        quaternion qx, qy, qz;
